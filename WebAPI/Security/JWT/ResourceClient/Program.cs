...
namespace ResourceClient
{
    public class Program
    {
        ...
        private static readonly string AuthServerBaseUrl = "https://localhost:7137"; // Authentication Server URL
        private static readonly string ResourceServerBaseUrl = "https://localhost:7170"; // Replace with your Resource Server's URL and port
        private static readonly string ClientId = "Client1"; // Must match a valid ClientId in Auth Server
        private static readonly string UserEmail = "admin@example.com"; // Replace with registered user's email
        private static readonly string UserPassword = "Admin@123"; // Replace with registered user's password
