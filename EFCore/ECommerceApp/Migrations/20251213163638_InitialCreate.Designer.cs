...
namespace ECommerceApp.Migrations
{
    ...
    [Migration("20251213163638_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerceApp.Models.Profile", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerceApp.Models.Order", b =>
                {
                    ...
                    b.HasOne("ECommerceApp.Models.OrderStatus", "OrderStatus")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("ECommerceApp.Models.Profile", b =>
                {
                    b.HasOne("ECommerceApp.Models.Customer", "Customer")
                        .WithOne("Profile")
                        .HasForeignKey("ECommerceApp.Models.Profile", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
